...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 w-full z-50 p-4 transition-all duration-300 ease-in-out ${
        isVisible
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        {/* Logo */}
        <h1 className="text-gray-100 text-2xl font-bold tracking-tight hover:text-blue-400 transition-colors">
          Anupama Sudarsan
        </h1>
