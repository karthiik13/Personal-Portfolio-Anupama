...
const certifications: Certification[] = [
  {
    ...
    imageUrl: 'images/certifications/MicrosoftPowerBI.png',
  ...
  },
  {
    ...
    issueDate: 'July 2020',
    imageUrl: 'images/certifications/IBMDataScienceCertificate.png',
  ...
  },
  {
    ...
    imageUrl: 'images/certifications/edxSupplyChainAnalytics.png',
...
const CertificationCard = ({ cert }: { cert: Certification }) => (
  <div className="group bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-700 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
